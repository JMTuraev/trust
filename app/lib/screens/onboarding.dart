...
class _OnboardingState extends State<Onboarding> {
        ...
        Expanded(child: Padding(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            Container(width: 56, height: 56,
                ...
                child: Text('T', style: TextStyle(color: p.bg, fontSize: 24, fontWeight: FontWeight.w700))),
  ...
  Widget _backBar(P p, VoidCallback onBack) => Padding(
  ...
  Widget _otp(P p) => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        _backBar(p, () => setState(() => step = 1)),
        Padding(
          padding: const EdgeInsets.fromLTRB(28, 6, 28, 0),
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              for (int i = 0; i < 5; i++) Padding(
                ...
                child: Container(width: 50, height: 58,
                    decoration: BoxDecoration(border: Border.all(color: i == 0 ? p.ink : p.bd), borderRadius: BorderRadius.circular(12)),
                    alignment: Alignment.center,
                    child: Text(i == 0 ? '4' : '', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w700, color: p.ink))),
              ),
            ]),
            const SizedBox(height: 24),
          ...
          for (int i = 0; i < 4; i++) Padding(
            ...
            child: Container(width: 14, height: 14,
                decoration: BoxDecoration(shape: BoxShape.circle,
                    ...
                    color: i < 2 ? p.ink : Colors.transparent)),
          ),
        ]),
        const Spacer(),
        Padding(
          padding: const EdgeInsets.fromLTRB(30, 0, 30, 26),
          child: InkButton('Davom etish', widget.onDone, p, height: 52),
        ),
      ]);
}
