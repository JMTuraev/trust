        ...
        children: [
          ...
          Expanded(
            child: StoreField(
              ...
              style: GoogleFonts.plusJakartaSans(fontSize: 15, fontWeight: FontWeight.w600, color: p.ink),
            ),
          ),
        ],
      ),
        ...
        children: [
          ...
          Expanded(
            ...
            child: StoreField(
              ...
              hint: cf('name'),
              style: GoogleFonts.plusJakartaSans(fontSize: 13.5, color: p.ink),
            ),
          ),
          ...
          Expanded(
            ...
            child: StoreField(
              ...
              style: GoogleFonts.plusJakartaSans(fontSize: 12.5, color: p.t1),
            ),
          ),
          Tap(
